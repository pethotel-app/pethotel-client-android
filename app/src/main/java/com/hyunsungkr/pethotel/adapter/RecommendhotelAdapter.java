...
public class RecommendhotelAdapter extends RecyclerView.Adapter<RecommendhotelAdapter.ViewHolder> {

    Context context;
    ArrayList<Hotel> recommendhotelList;
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        Hotel hotel = recommendhotelList.get(position);
    ...
    public int getItemCount() {
        return recommendhotelList.size();
    }
